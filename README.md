...
1. Clone o repositório
  * `git clone https://github.com/AndersonSilva94/project-cookmaster.git`.
...
3. Crie um arquivo `.env` na raiz da aplicação e coloque o seguinte valor:
  * `HOST=localhost`

4. Rode os testes
  * Para isso você deve dar um start da aplicação no terminal, basta rodar o comando:
    * `npm run dev`
  * Em seguida, abra um novo terminal e rode o seguinte o comando:
    * `npm test`
  * Todos os testes devem estar passando

5. você pode verificar os testes de integração também, basta parar o servidor e rodar o comando:
  * `npm run dev:test`
